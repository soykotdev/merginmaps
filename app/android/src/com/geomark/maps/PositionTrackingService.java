...
import com.geomark.maps.PositionTrackingBroadcastMiddleware;
...
public class PositionTrackingService extends Service implements LocationListener {
    ...
    public int onStartCommand( Intent intent, int flags, int startId ) {
        ...
        if ( !isGPSAvailable ) {
            ...
            if ( intent.hasExtra( "com.geomark.maps.tracking.timeInterval" ) ) {
                timeInterval = (long) intent.getDoubleExtra( "com.geomark.maps.tracking.timeInterval", 1000 );
            }

            if ( intent.hasExtra( "com.geomark.maps.tracking.distanceInterval" ) ) {
                distanceInterval = (long) intent.getDoubleExtra( "com.geomark.maps.tracking.distanceInterval", 1 );
            }
