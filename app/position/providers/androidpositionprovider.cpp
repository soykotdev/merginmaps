  ...
  , mInstanceId( ++sLastInstanceId )
{
  ...
  javaenv.registerNativeMethods( "com/geomark/maps/MMAndroidPosition", methods, 1 );
  ...
  mAndroidPos = QJniObject::callStaticObjectMethod(
                  "com/geomark/maps/MMAndroidPosition",
                  "createWithJniCallback",
                  "(Landroid/content/Context;ZI)Lcom/geomark/maps/MMAndroidPosition;",
                  context.object(),
                  mFused,
                  mInstanceId );
...
{
  return QJniObject::callStaticMethod<jboolean>( "com/geomark/maps/MMAndroidPosition", "isFusedLocationProviderAvailable",
